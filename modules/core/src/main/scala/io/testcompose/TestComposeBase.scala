...
//  * @tparam Config
//  *   The config provided to build context
//  */
//private[testcompose] trait TestComposeBase[F[_], Config, Context] { self =>
//
//  final protected val defaultDockerComposePath = "compose.yaml"
//
//  type Containers = TestComposeContainer | NoopContainer
//
//  private var dockerComposeFileConf: String = defaultDockerComposePath
//  private var useTestcontainers: Boolean    = true
//
